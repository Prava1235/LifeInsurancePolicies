...
public class EmployeePoliciesServiceTest {
                ...
                public void testEnrolEmployeePolicy(){
                	...
                	enrolPolicy.setEndDate(date);
                	 ...
                	 AvailablePolicies availablePolicie = new AvailablePolicies();
                                ...
                                Mockito.when(employeePoliciesRepository.save(Mockito.any(EmployeePolicies.class))).thenReturn(employeePolicies);
