...
public class AvailablePoliciesController {
	...
	public ResponseEntity<List<AvailablePolicies>> getPolicies() throws Exception {
		LOGGER.debug("AvailablePoliciesController :: All Policies :: start");
		List<AvailablePolicies> availablePoliciesResponseList = availablePoliciesService.getPolicies();
